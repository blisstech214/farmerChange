...
import { SelectBox, TextBox, ToggleBox, UploadFileBox } from "../../form";
  ...
  return (
    ...
    >
      ...
      <ToggleBox
        ...
        onChange={(e) => formik.setFieldValue("adddoctorannotaion", e)}
        error={
          formik.touched.adddoctorannotaion && formik.errors.adddoctorannotaion
        }
        helperText={
          formik.touched.adddoctorannotaion && formik.errors.adddoctorannotaion
        }
