                ...
                <Stack spacing={2}>
                  <Stack direction={'row'} spacing={2}>
                    <Box sx={{ width: { md: '40px', sm: '55px', xs: '55px' } }}>
                      <img width="100%" src={'/homepage/logo.png'} alt="Doctorsplaza" />
                    </Box>
                    <Typography
                      sx={{
                        display: 'flex',
                  ...
                  <Stack direction={'row'} spacing={2}>
                    <Box sx={{ width: { md: '40px', sm: '40px', xs: '40px' } }}>
                      <img width="100%" src={'/homepage/multi_specialists.png'} alt="Doctorsplaza" />
                    </Box>
                    <Typography
                      sx={{
                        display: 'flex',
                  ...
                  <Stack direction={'row'} spacing={2}>
                    <Box sx={{ width: { md: '60px', sm: '80px', xs: '80px' } }}>
                      <img width="100%" src={'/homepage/online_and_offline_consultations.png'} alt="Doctorsplaza" />
                    </Box>
                    <Typography
                      sx={{
                        display: 'flex',
